...
function Mostrar-Menu {
    ...
    Write-Host "6. Verificar servicios instalados"
    Write-Host "7. Salir"
    Write-Host "=================================="
}
...
while ($true) {
    ...
    switch ($opcion_menu) {
        ...
        "1" {
            seleccionar_protocolo  # Nueva opción para seleccionar HTTP o HTTPS
            Read-Host "Presione Enter para continuar..."
        }
        "2" {
        ...
        "6" {
            Write-Host "Verificando servicios instalados..."
            # Aquí podrías agregar una función para listar servicios activos
            Read-Host "Presione Enter para continuar..."
        }
        "7" {
            Write-Host "Saliendo..."
